...
function (_Component) {
  ...
  _createClass(Sticky, [{
    ...
    value: function render() {
      ...
      var containerClasses = cx(className, 'ui', sticky && 'stuck-container', sticky && bound && 'bound-container', sticky && !bound && 'fixed-container');
      ...
      return React.createElement(ElementType, _extends({}, rest, {
        ...
        className: cx.apply(void 0, elementClasses),
